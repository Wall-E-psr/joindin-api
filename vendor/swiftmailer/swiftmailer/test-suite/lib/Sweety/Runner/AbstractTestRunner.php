...
abstract class Sweety_Runner_AbstractTestRunner implements Sweety_Runner
{
  ...
  */
   ...
   * @access private
   */
    private function _parseFormatted(
        SimpleXMLElement $formatted,
        $path = '',
   ...
   * @access private
   */
    private function _parseFailure(
        SimpleXMLElement $failure,
        $path = '',
        Sweety_Reporter $reporter
    ) {
   ...
   * @access private
   */
    private function _parsePass(
        SimpleXMLElement $pass,
        $path = '',
        Sweety_Reporter $reporter
    ) {
   ...
   * @access private
   */
    private function _parseTestCase(
   ...
   * @access private
   */
    private function _parseDocument(
        SimpleXMLElement $document,
        $path = '',
        Sweety_Reporter $reporter
    ) {
